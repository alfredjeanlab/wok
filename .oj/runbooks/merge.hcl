...
#
# Examples:
#   oj run merge fix/wk-abc123 "fix: search results don't include notes"
#   oj run merge feature/edit-flags-def456 "feat: add hidden edit flags"
...
agent "resolver" {
  ...
  on_idle  = { action = "gate", run = "make check-fast", attempts = 5 }
